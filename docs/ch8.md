...
```
[Using var in lambda](../src/main/java/org/diegodamian/ocp17/book/ch8/lambda/UsageOfVarInLambda.java)
...
[LambdaEffectiveFinal](../src/main/java/org/diegodamian/ocp17/book/ch8/lambda/LambdaEffectiveFinal.java)
#### Rules
...
### Consumer
[Consumer](../src/main/java/org/diegodamian/ocp17/book/ch8/functionalinterface/jdk/UsageOfConsumer.java)
#### andThen
```java
...
[Functional Interfaces](../src/main/java/org/diegodamian/ocp17/book/ch8/functionalinterface/UsageOfFunctionalInterface.java)

### Main Functional Interfaces (generated by GPT)
