...
$ java -cp target/classes ch1.book.org.diegodamian.ocp17.HelloWorld
```
...
```shell
$ java -cp target/classes ch1.book.org.diegodamian.ocp17.HelloWorld
$ java -classpath target/classes ch1.book.org.diegodamian.ocp17.HelloWorld
$ java --class-path target/classes ch1.book.org.diegodamian.ocp17.HelloWorld
```
## Variables
...
```java
    ...
    int £€$ = 55;
```
[Possible names for variables](../src/main/java/org/diegodamian/ocp17/book/ch1/NameOfVariables.java)
...
```
[Usage of var](../src/main/java/org/diegodamian/ocp17/book/ch1/UsageOfVar.java)
### Garbage Collection
```java
 System.gc();
```
...
[Text Blocks](../src/main/java/org/diegodamian/ocp17/book/ch1/textblocks/TextBlocks.java)
```java
String tb = """
    Hello
    World""";
