# JDBC
## Setup
Run the [SetupDataBase](../src/main/java/org/diegodamian/ocp17/book/ch15/SetupDataBase.java) 
...
## Procedure
[Store Procedure](../src/main/java/org/diegodamian/ocp17/book/ch15/StoredProcedure.java)
...
```
[SavePoint](../src/main/java/org/diegodamian/ocp17/book/ch15/rollback/SavePoint.java)
...
```
[Rollback](../src/main/java/org/diegodamian/ocp17/book/ch15/rollback/CommitAndRollback.java)
